...
export default function OrdersAdminPage(){
  ...
  return(
    <div className="w-full h-full flex flex-col justify-between">
      ...
      <table className="w-full border-[3px] border-gray-300 bg-white">
        <thead className="bg-gray-300">
          <tr>
            <th className="p-[10px] border border-gray-500">Order ID</th>
						<th className="p-[10px] border border-gray-500">Email</th>
						<th className="p-[10px] border border-gray-500">Name</th>
						<th className="p-[10px] border border-gray-500">Address</th>
						<th className="p-[10px] border border-gray-500">Phone</th>
						<th className="p-[10px] border border-gray-500">Status</th>
						<th className="p-[10px] border border-gray-500">Date</th>
						<th className="p-[10px] border border-gray-500">Total</th>
          </tr>
        </thead>
        <tbody>
            {
              orders.map((order, index) => {
                return(
                  <tr key={index} className="border-b-[1px] hover:bg-blue-400 cursor-pointer" onClick={
                    ...
                    <td className="p-[10px] border border-gray-500">{order.orderId}</td>
                    <td className="p-[10px] border border-gray-500">{order.email}</td>
                    <td className="p-[10px] border border-gray-500">{order.name}</td>
                    <td className="p-[10px] border border-gray-500">{order.address}</td>
                    <td className="p-[10px] border border-gray-500">{order.phone}</td>
                    <td className="p-[10px] border border-gray-500">{order.status}</td>
                    <td className="p-[10px] border border-gray-500">
                      {new Date(order.date).toLocaleDateString()}
                    </td>
                    <td className="p-[10px] border border-gray-500 text-end">
